...
namespace Consola
{
    class Program
    {
        ...
        public void Comparar(string texto1, string texto2, DelegadoComparacion criterioComparacion)
        {
            if(criterioComparacion(texto1,texto2) > 0) 
            {
                Console.WriteLine("El primer texto es el mayor");
            }
            else if(criterioComparacion(texto1, texto2)  < 0) 
            {
                Console.WriteLine("El segundo texto es el menor");
            }
            else if(criterioComparacion(texto1, texto2) == 0) 
            {
        ...
        static void Main(string[] args)
        {
            ...
            // Punto 2
            Console.WriteLine(Comparar(primerTexto, segundoTexto,(primerTexto,segundoTexto) => );
